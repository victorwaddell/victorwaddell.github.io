module Contexts
  module ItemPrices
    ...
    #   create_pan_prices_wholesale
    #   create_utensil_prices_wholesale
    #   create_ingredient_prices_wholesale
    # end

    # def create_pan_prices_wholesale
    #   @bs1w = FactoryBot.create(:item_price, item: @baking_sheet, price: 2.95, start_date: 24.months.ago.to_date, is_retail: false)
    #   @bs1w.update_attribute(:start_date, 24.months.ago.to_date)
    #   @bs3w = FactoryBot.create(:item_price, item: @baking_sheet, price: 2.75, start_date: 42.weeks.ago.to_date, is_retail: false)
    #   @bs3w.update_attribute(:start_date, 42.weeks.ago.to_date)
    #   @bs1w.update_attribute(:end_date, 42.weeks.ago.to_date - 1)
    #   @bs4w = FactoryBot.create(:item_price, item: @baking_sheet, price: 3.25, start_date: 6.months.ago.to_date, is_retail: false)
    #   @bs4w.update_attribute(:start_date, 6.months.ago.to_date)
    #   @bs3w.update_attribute(:end_date, 6.months.ago.to_date - 1)
    #   @bs5w = FactoryBot.create(:item_price, item: @baking_sheet, price: 3.95, start_date: 4.weeks.ago.to_date, is_retail: false)
    #   @bs5w.update_attribute(:start_date, 4.weeks.ago.to_date)
    #   @bs4w.update_attribute(:end_date, 4.weeks.ago.to_date - 1)

    #   @mt1w = FactoryBot.create(:item_price, item: @muffin_tray, price: 2.25, start_date: 24.months.ago.to_date, is_retail: false)
    #   @mt1w.update_attribute(:start_date, 24.months.ago.to_date)
    #   @mt2w = FactoryBot.create(:item_price, item: @muffin_tray, price: 2.75, start_date: 13.months.ago.to_date, is_retail: false)
    #   @mt2w.update_attribute(:start_date, 13.months.ago.to_date)
    #   @mt1w.update_attribute(:end_date, 13.months.ago.to_date - 1)
    #   @mt3w = FactoryBot.create(:item_price, item: @muffin_tray, price: 2.95, start_date: 180.days.ago.to_date, is_retail: false)
    #   @mt3w.update_attribute(:start_date, 180.days.ago.to_date)
    #   @mt2w.update_attribute(:end_date, 180.days.ago.to_date - 1)
    #   @mt4w = FactoryBot.create(:item_price, item: @muffin_tray, price: 2.50, start_date: 3.weeks.ago.to_date, is_retail: false)
    #   @mt4w.update_attribute(:start_date, 3.weeks.ago.to_date)
    #   @mt3w.update_attribute(:end_date, 3.weeks.ago.to_date - 1)

    #   @rcp1w = FactoryBot.create(:item_price, item: @round_cake_pans, price: 5.05, start_date: 24.months.ago.to_date, is_retail: false)
    #   @rcp1w.update_attribute(:start_date, 24.months.ago.to_date)
    #   @rcp2w = FactoryBot.create(:item_price, item: @round_cake_pans, price: 5.55, start_date: 13.months.ago.to_date, is_retail: false)
    #   @rcp2w.update_attribute(:start_date, 13.months.ago.to_date)
    #   @rcp1w.update_attribute(:end_date, 13.months.ago.to_date - 1)
    #   @rcp3w = FactoryBot.create(:item_price, item: @round_cake_pans, price: 5.75, start_date: 180.days.ago.to_date, is_retail: false)
    #   @rcp3w.update_attribute(:start_date, 180.days.ago.to_date)
    #   @rcp2w.update_attribute(:end_date, 180.days.ago.to_date - 1)
    #   @rcp4w = FactoryBot.create(:item_price, item: @round_cake_pans, price: 6.40, start_date: 3.weeks.ago.to_date, is_retail: false)
    #   @rcp4w.update_attribute(:start_date, 3.weeks.ago.to_date)
    #   @rcp3w.update_attribute(:end_date, 3.weeks.ago.to_date - 1)

    #   @scp1w = FactoryBot.create(:item_price, item: @square_cake_pan, price: 2.70, start_date: 14.months.ago.to_date, is_retail: false)
    #   @scp1w.update_attribute(:start_date, 14.months.ago.to_date)
    #   @scp2w = FactoryBot.create(:item_price, item: @square_cake_pan, price: 3.25, start_date: 6.months.ago.to_date, is_retail: false)
    #   @scp2w.update_attribute(:start_date, 6.months.ago.to_date)
    #   @scp1w.update_attribute(:end_date, 6.months.ago.to_date - 1)
    #   @scp3w = FactoryBot.create(:item_price, item: @square_cake_pan, price: 3.60, start_date: 14.days.ago.to_date, is_retail: false)
    #   @scp3w.update_attribute(:start_date, 14.days.ago.to_date)
    #   @scp2w.update_attribute(:end_date, 14.days.ago.to_date - 1)
    # end

    # def create_utensil_prices_wholesale
    #   @whk1w = FactoryBot.create(:item_price, item: @whisk, price: 1.95, start_date: 12.months.ago.to_date, is_retail: false)
    #   @whk1w.update_attribute(:start_date, 12.months.ago.to_date)
    #   @whk2w = FactoryBot.create(:item_price, item: @whisk, price: 2.50, start_date: 6.months.ago.to_date, is_retail: false)
    #   @whk2w.update_attribute(:start_date, 6.months.ago.to_date)
    #   @whk1w.update_attribute(:end_date, 6.months.ago.to_date - 1)
    #   @whk3w = FactoryBot.create(:item_price, item: @whisk, price: 3.25, start_date: 2.weeks.ago.to_date, is_retail: false)
    #   @whk3w.update_attribute(:start_date, 2.weeks.ago.to_date)
    #   @whk2w.update_attribute(:end_date, 2.weeks.ago.to_date - 1)

    #   @spt1 = FactoryBot.create(:item_price, item: @spatula, price: 6.95, start_date: 12.months.ago.to_date, is_retail: false)
    #   @spt1.update_attribute(:start_date, 12.months.ago.to_date)
    #   @spt2 = FactoryBot.create(:item_price, item: @spatula, price: 7.50, start_date: 6.months.ago.to_date, is_retail: false)
    #   @spt2.update_attribute(:start_date, 6.months.ago.to_date)
    #   @spt1.update_attribute(:end_date, 6.months.ago.to_date - 1)
    #   @spt3 = FactoryBot.create(:item_price, item: @spatula, price: 7.95, start_date: 1.week.ago.to_date, is_retail: false)
    #   @spt3.update_attribute(:start_date, 1.week.ago.to_date)
    #   @spt2.update_attribute(:end_date, 1.week.ago.to_date - 1)   
    # end

    # def create_ingredient_prices_wholesale
    #   @fl1w = FactoryBot.create(:item_price, item: @flour, price: 1.95, start_date: 6.months.ago.to_date, is_retail: false)
