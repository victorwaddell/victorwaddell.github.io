...
class UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user" do
    assert_difference('User.count') do
      post users_path, params: { user: { username: 'jgordon', password: 'secret', password_confirmation: 'secret', role: 'admin', active: true } }
    end
    assert_equal "Successfully added jgordon as a user.", flash[:notice]
    assert_redirected_to users_path

    post users_path, params: { user: { username: nil, password: 'secret', password_confirmation: 'secret', role: 'admin', active: true } }
    assert_template :new
  end
  ...
  test "should update user" do
    patch user_path(@user), params: { user: { username: @user.username, password: 'secret', password_confirmation: 'secret', role: 'shipper', active: true } }
    assert_redirected_to users_path 
